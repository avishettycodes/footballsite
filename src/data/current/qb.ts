...
const POOLS: Record<string, Row[]> = {
  ari: [
    ...
    ['now-ari-tune', 'Clayton Tune', '2023–2025', 'Threw 62 passes as a rookie and completed fewer than half of them.', 82, 60, 74, 56, 74, 62, 46],
  ...
  bal: [
    ...
    ['now-bal-cunningham', 'Malik Cunningham', '2024–2025', 'A college quarterback the league keeps trying to turn into a receiver.', 76, 58, 62, 54, 92, 56, 46],
    ['now-bal-leary', 'Devin Leary', '2024–2025', 'Sixth round arm who has spent two seasons holding a clipboard in the cold.', 86, 66, 82, 56, 66, 62, 48],
  ...
  buf: [
    ...
    ['now-buf-buechele', 'Shane Buechele', '2023–2025', 'Started at Texas, transferred to SMU, and has thrown eleven pro passes.', 78, 72, 74, 58, 62, 68, 50],
  ...
  car: [
    ...
    ['now-car-plummer', 'Jack Plummer', '2024–2025', 'Undrafted out of Louisville and has never been active on a game day.', 76, 70, 72, 56, 60, 66, 46],
  ],
  chi: [
    ...
    ['now-chi-pjwalker', 'P.J. Walker', '2024–2025', 'Signed to hold the ball for kicks and take the last drive of August.', 76, 68, 72, 58, 74, 66, 58],
  ],
  cin: [
    ...
    ['now-cin-jjohnson', 'Josh Johnson', '2026–', 'Cincinnati is somewhere near the sixteenth stop and the spiral is still lovely.', 82, 74, 78, 68, 68, 78, 62],
  ...
  cle: [
    ...
    ['now-cle-dtr', 'Dorian Thompson-Robinson', '2023–2025', 'A fifth round athlete asked to start before he was ready, twice.', 84, 64, 72, 58, 90, 62, 50],
  ...
  det: [
    ...
    ['now-det-martinez', 'Adrian Martinez', '2024–2025', 'Ran for 1,000 yards at Nebraska and is a practice squad arm now.', 78, 64, 72, 56, 90, 60, 46],
  ...
  hou: [
    ...
    ['now-hou-driskel', 'Jeff Driskel', '2023–2025', 'Has played quarterback, tight end and special teams for money.', 82, 68, 78, 60, 86, 64, 52],
  ...
  ind: [
    ...
    ['now-ind-minshew', 'Gardner Minshew', '2023–2025', 'The mustache is the point, and a photograph of him in jorts lives online forever.', 82, 84, 82, 66, 70, 84, 84],
  ...
  jax: [
    ...
    ['now-jax-beathard', 'C.J. Beathard', '2021–2025', 'Son and grandson of football men, and a career spent holding the ball.', 82, 74, 78, 74, 66, 74, 58],
  ...
  kc: [
    ...
    ['now-kc-oladokun', 'Chris Oladokun', '2022–2025', 'Four colleges and three practice squads later, he has never given the dream up.', 84, 66, 80, 56, 86, 62, 46],
  ...
  lv: [
    ...
    ['now-lv-miller', 'Cam Miller', '2025–2025', 'North Dakota State keeps producing these, and he is the latest one to arrive.', 88, 72, 90, 60, 86, 70, 58],
  ...
  lar: [
    ...
    ['now-lar-garoppolo', 'Jimmy Garoppolo', '2024–2025', 'Handsome enough for a razor advert and permanently one bad week from the bench.', 82, 84, 74, 82, 52, 78, 74],
  ],
  mia: [
  ...
  no: [
    ...
    ['now-no-hill', 'Taysom Hill', '2017–2025', 'Plays quarterback, tight end, and returns kicks, all in the same afternoon.', 88, 66, 82, 62, 96, 62, 76],
  ...
  nyg: [
    ...
    ['now-nyg-rwilson', 'Russell Wilson', '2025–2025', 'Threw for 450 yards in September and lost the job by Halloween.', 84, 82, 88, 62, 66, 80, 74],
  ...
  nyj: [
    ...
    ['now-nyj-travis', 'Jordan Travis', '2024–2025', 'Had Florida State unbeaten until his leg snapped on national television.', 80, 74, 76, 60, 82, 72, 62],
  ...
  sf: [
    ...
    ['now-sf-mordecai', 'Tanner Mordecai', '2024–2025', 'Undrafted out of Wisconsin, and August is the only football he has played here.', 82, 66, 78, 56, 76, 62, 46],
  ...
  tb: [
    ...
    ['now-tb-trask', 'Kyle Trask', '2021–2025', 'A second round pick who has waited five seasons for somebody to say go.', 86, 82, 78, 76, 50, 74, 62],
  ...
  ten: [
    ...
    ['now-ten-levis', 'Will Levis', '2023–2025', 'Six foot four with a cannon, and the mayonnaise in his coffee is what people repeat.', 97, 64, 76, 56, 72, 60, 58],
