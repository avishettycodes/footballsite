...
const POOLS: Record<string, Row[]> = {
  ari: [
    ['now-ari-murray', 'Kyler Murray', '2019–', 'Gone the moment you blink, and the throws come out sideways when he is bored.', 92, 90, 90, 80, 96, 86, 88],
  ...
  atl: [
    ...
    ['now-atl-cousins', 'Kirk Cousins', '2024–2025', 'Signed the biggest deal in team history and lost the job inside a year.', 82, 92, 78, 82, 40, 86, 56],
    ['now-atl-stick', 'Easton Stick', '2025–', 'Watched Herbert throw for five seasons and it did not rub off.', 80, 80, 74, 66, 68, 70, 60],
  ...
  bal: [
    ...
    ['now-bal-rush', 'Cooper Rush', '2025–', 'Won nine of fourteen as an emergency starter and got paid for it.', 78, 82, 72, 78, 46, 84, 82],
    ...
    ['now-bal-jjohnson', 'Josh Johnson', '2024–', 'Has signed with fifteen franchises and still throws a lovely spiral at 39.', 82, 74, 78, 68, 68, 78, 62],
  ...
  buf: [
    ...
    ['now-buf-trubisky', 'Mitchell Trubisky', '2023–', 'Went second overall and has settled quite happily into carrying a tablet.', 84, 74, 78, 70, 80, 66, 58],
    ['now-buf-white', 'Mike White', '2024–', 'Beat Cincinnati in his second career start and never got another one.', 82, 78, 80, 62, 44, 74, 66],
    ...
    ['now-buf-kallen', 'Kyle Allen', '2023–2024', 'Started 22 games for three bad teams and lost eighteen of them.', 82, 72, 78, 74, 56, 70, 54],
  ...
  car: [
    ...
    ['now-car-dalton', 'Andy Dalton', '2022–', 'The Red Rifle at 38, still good for one clean afternoon a month.', 82, 88, 80, 90, 42, 84, 80],
  ...
  cin: [
    ...
    ['now-cin-browning', 'Jake Browning', '2023–', 'Went undrafted, sat for four seasons, then threw for 300 on a Monday night.', 78, 88, 80, 82, 60, 82, 76],
    ['now-cin-woodside', 'Logan Woodside', '2024–', 'Owns every record Toledo keeps and has been a third stringer ever since.', 76, 72, 70, 58, 60, 68, 48],
    ...
    ['now-cin-finley', 'Ryan Finley', '2019–2021', 'Started three games as a rookie and threw for 470 yards all season.', 78, 64, 72, 58, 66, 64, 44],
  ...
  cle: [
    ...
    ['now-cle-pickett', 'Kenny Pickett', '2025–', 'A first round pick with famously small hands, now on his third team.', 82, 78, 76, 86, 72, 76, 62],
  ...
  dal: [
    ...
    ['now-dal-grier', 'Will Grier', '2022–2024', 'Two career starts, no touchdowns, and a decade on other people\'s practice squads.', 82, 68, 78, 58, 58, 64, 44],
  ],
  den: [
  ...
  det: [
    ...
    ['now-det-hooker', 'Hendon Hooker', '2023–', 'Tore a knee in November, went in the third round, and has barely played since.', 90, 74, 84, 62, 78, 70, 58],
    ...
    ['now-det-sudfeld', 'Nate Sudfeld', '2022–', 'Has been in the league nine seasons and thrown 37 passes total.', 80, 70, 76, 60, 58, 68, 48],
  ...
  gb: [
    ...
    ['now-gb-willis', 'Malik Willis', '2024–', 'Arrived in a trade for a fourth and won two starts nobody expected.', 92, 72, 86, 62, 92, 68, 74],
    ['now-gb-clifford', 'Sean Clifford', '2023–', 'Started 50 games at Penn State and has yet to throw a pass that counted.', 80, 70, 76, 60, 70, 68, 50],
  ...
  hou: [
    ...
    ['now-hou-slovis', 'Kedon Slovis', '2024–', 'Played for four colleges in five years and is somebody\'s arm in camp now.', 78, 70, 74, 56, 60, 66, 46],
  ],
  ind: [
  ...
  jax: [
    ...
    ['now-jax-wolford', 'John Wolford', '2023–2024', 'Won a playoff spot for the Rams once, which nobody outside the building recalls.', 70, 76, 66, 62, 74, 82, 58],
  ...
  kc: [
    ...
    ['now-kc-minshew', 'Gardner Minshew', '2025–', 'Signed to hold a clipboard behind the best there is and enjoys the gig.', 80, 78, 78, 64, 68, 76, 66],
    ['now-kc-wentz', 'Carson Wentz', '2024', 'Nearly won an MVP in 2017 and has been somebody\'s backup every year since.', 90, 74, 88, 64, 74, 72, 62],
  ...
  lv: [
    ['now-lv-geno', 'Geno Smith', '2025–', 'Nobody wanted him for the better part of a decade and he starts at 35.', 90, 92, 86, 88, 72, 90, 86],
  ...
  mia: [
    ['now-mia-tua', 'Tua Tagovailoa', '2020–', 'Fastest release in football, and everybody holds their breath when he goes down.', 78, 97, 92, 70, 62, 90, 78],
    ['now-mia-zwilson', 'Zach Wilson', '2025–', 'Fourth stop for a second overall pick who is still only 26.', 92, 70, 84, 58, 80, 64, 48],
    ['now-mia-ewers', 'Quinn Ewers', '2025–', 'Was the number one recruit in America before he had a driving licence.', 88, 82, 84, 80, 66, 74, 60],
  ...
  min: [
    ...
    ['now-min-howell', 'Sam Howell', '2025–', 'Was sacked 65 times in one season and kept getting back up.', 86, 76, 84, 58, 76, 72, 60],
    ['now-min-brosmer', 'Max Brosmer', '2025–', 'Undrafted local kid who talked his way onto the roster in August.', 78, 74, 74, 62, 62, 80, 54],
    ['now-min-mullens', 'Nick Mullens', '2022–2024', 'Threw for 300 yards four times here and lost every one of those games.', 80, 78, 78, 62, 46, 76, 56],
  ...
  ne: [
    ...
    ['now-ne-dobbs', 'Joshua Dobbs', '2025–', 'An aerospace engineer who keeps getting hired to learn playbooks fast.', 86, 76, 82, 68, 82, 80, 74],
  ...
  no: [
    ...
    ['now-no-haener', 'Jake Haener', '2023–', 'Fourth round pick out of Fresno who competes for every rep he gets.', 78, 78, 74, 64, 62, 76, 62],
  ...
  nyg: [
    ...
    ['now-nyg-devito', 'Tommy DeVito', '2023–', 'Undrafted kid from New Jersey who won three straight and became a folk hero.', 80, 74, 76, 60, 74, 70, 80],
  ...
  nyj: [
    ['now-nyj-fields', 'Justin Fields', '2025–', 'Still the fastest quarterback alive and still nobody knows where the ball is going.', 90, 70, 86, 58, 97, 68, 66],
    ['now-nyj-tyrod', 'Tyrod Taylor', '2024–', 'Fifteen seasons of being quietly better than whoever is starting ahead of him.', 84, 80, 76, 78, 88, 78, 70],
    ...
    ['now-nyj-siemian', 'Trevor Siemian', '2021', 'Came in cold in October and threw it 30 times before anyone knew he was there.', 78, 72, 74, 72, 52, 74, 56],
  ],
  phi: [
    ...
    ['now-phi-book', 'Ian Book', '2022–2024', 'Won 30 games at Notre Dame and has thrown 20 professional passes.', 76, 72, 70, 58, 74, 70, 50],
  ],
  pit: [
  ...
  tb: [
    ...
    ['now-tb-griffin', 'Ryan Griffin', '2015–2021', 'Seven seasons on the roster and not one regular season pass attempt.', 80, 70, 76, 60, 56, 70, 44],
  ],
  ten: [
    ...
    ['now-ten-boyle', 'Tim Boyle', '2024', 'Has been signed by six teams and won exactly one start for any of them.', 82, 66, 76, 58, 58, 64, 44],
  ],
  was: [
