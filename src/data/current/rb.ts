...
const POOLS: Record<string, Row[]> = {
  ...
  atl: [
    ...
    ['now-atl-allgeier', 'Tyler Allgeier', '2022–2025', 'Fifth round bruiser who ran for 1,035 yards as a rookie behind him.', 80, 84, 70, 92, 86, 68, 80],
  ...
  det: [
    ...
    ['now-det-montgomery', 'David Montgomery', '2023–2025', 'Falls forward every single time and scored 40 touchdowns in three seasons.', 78, 82, 74, 94, 88, 78, 90],
  ...
  ind: [
    ...
    ['now-ind-goodson', 'Tyler Goodson', '2023–2025', 'Dropped a fourth down pass that ended a season and stayed on the roster.', 90, 88, 82, 64, 76, 72, 62],
  ...
  sea: [
    ...
    ['now-sea-kwalker', 'Kenneth Walker III', '2022–2025', 'Makes one cut that nobody in the stadium sees coming, twice a game.', 94, 94, 96, 82, 84, 76, 78],
  ...
  was: [
    ...
    ['now-was-crodriguez', 'Chris Rodriguez', '2023–2025', 'Sixth round back from Kentucky who only plays when everyone else is hurt.', 80, 82, 70, 88, 76, 66, 86],
