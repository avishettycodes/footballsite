...
const POOLS: Record<string, Row[]> = {
  ...
  bal: [
    ...
    ['now-bal-likely', 'Isaiah Likely', '2022–2025', 'Fourth round pick who would start for about twenty other teams.', 90, 76, 88, 86, 88, 84, 88],
  ...
  cle: [
    ['now-cle-njoku', 'David Njoku', '2017–2025', 'Ran into a burning house to save a child, and he catches everything now.', 92, 74, 90, 84, 88, 94, 88],
  ...
  ind: [
    ...
    ['now-ind-woods', 'Jelani Woods', '2022–2025', 'Six foot seven, ran a 4.61, and has been hurt for three straight years.', 82, 82, 86, 76, 76, 76, 99],
  ],
  jax: [
  ...
  mia: [
    ...
    ['now-mia-julianhill', 'Julian Hill', '2023–', 'Undrafted from Campbell and blocks on 90 percent of his snaps.', 68, 92, 76, 66, 62, 90, 88],
    ...
    ['now-mia-smythe', 'Durham Smythe', '2018–2024', 'Seven seasons of blocking here and never more than 35 catches.', 74, 92, 72, 72, 64, 90, 88],
  ],
  min: [
    ...
    ['now-min-mundt', 'Johnny Mundt', '2022–2025', 'Scored for the first time in year seven and the bench emptied for him.', 78, 84, 74, 74, 68, 84, 84],
  ...
  ne: [
    ...
    ['now-ne-hooper', 'Austin Hooper', '2024–2025', 'Two Pro Bowls a long time ago, and he still catches everything short.', 88, 80, 74, 84, 70, 84, 88],
  ...
  no: [
    ...
    ['now-no-moreau', 'Foster Moreau', '2023–2025', 'Was diagnosed with cancer at a free agency physical and played that year.', 84, 84, 76, 80, 70, 94, 90],
  ...
  nyj: [
    ...
    ['now-nyj-nealjohnson', 'Kenyon Sadiq', '2026–', 'They spent a first round pick on a tight end, which teams have stopped doing.', 86, 78, 88, 80, 84, 84, 86],
  ...
  ten: [
    ['now-ten-okonkwo', 'Chigoziem Okonkwo', '2022–2025', 'Ran past two linebackers a game as a rookie and then got forgotten about.', 90, 74, 90, 82, 90, 84, 82],
