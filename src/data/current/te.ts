...
const POOLS: Record<string, Row[]> = {
  ari: [
    ...
    ['now-ari-reiman', 'Tip Reiman', '2024–2025', 'Third round pick who was drafted to block and does nothing else.', 74, 94, 78, 62, 62, 92, 92],
  ...
  bal: [
    ...
    ['now-bal-ricard', 'Patrick Ricard', '2017–2025', 'Plays fullback and defensive tackle, and has made five Pro Bowls doing it.', 68, 97, 66, 58, 60, 97, 97],
    ['now-bal-kolar', 'Charlie Kolar', '2022–2025', 'Iowa State record holder who blocks on the goal line and plays special teams.', 84, 88, 74, 70, 66, 88, 94],
  ],
  buf: [
    ...
    ['now-buf-davidson', 'Zach Davidson', '2024–2025', 'Was a punter in college who is now six foot seven and catching passes.', 74, 82, 80, 70, 66, 82, 96],
    ['now-buf-morris', 'Quintin Morris', '2021–2025', 'Undrafted from Bowling Green who has made five rosters on toughness.', 76, 88, 78, 72, 68, 92, 86],
  ],
  car: [
    ...
    ['now-car-franks', 'Feleipe Franks', '2024–', 'Carolina moved him from quarterback to tight end and it actually took.', 72, 84, 80, 68, 70, 86, 92],
    ['now-car-tremble', 'Colin Granger', '2025–2025', 'Played college basketball until 2023 and is learning this in public.', 80, 76, 84, 66, 70, 78, 94],
  ...
  cin: [
    ...
    ['now-cin-grandy', 'Cam Grandy', '2025–2025', 'Illinois State tight end who is here to catch passes in August.', 78, 78, 76, 74, 70, 80, 88],
  ],
  cle: [
    ...
    ['now-cle-bates', 'Brenden Bates', '2025–2025', 'Kentucky blocker signed off the street in September.', 70, 90, 74, 66, 62, 88, 86],
  ...
  dal: [
    ...
    ['now-dal-stephens', 'John Stephens Jr.', '2024–2025', 'Louisiana Tech receiver who was moved to tight end and back again.', 80, 64, 88, 74, 76, 78, 84],
    ['now-dal-fant', 'Princeton Fant', '2025–2025', 'Played four positions at Tennessee and none of them especially well.', 74, 84, 78, 70, 68, 84, 84],
  ],
  den: [
    ...
    ['now-den-lohner', 'Caleb Lohner', '2025–2025', 'Played four seasons of college basketball and caught his first pass at 24.', 82, 74, 84, 64, 70, 78, 92],
  ...
  det: [
    ...
    ['now-det-zylstra', 'Shane Zylstra', '2021–2025', 'Was a receiver at a Division II school and caught three touchdowns one day.', 80, 80, 78, 74, 70, 82, 86],
    ['now-det-yeboah', 'Kenny Yeboah', '2025–2025', 'Fifth year on a practice squad somewhere, and he keeps getting calls.', 78, 82, 80, 74, 70, 82, 86],
  ],
  gb: [
    ...
    ['now-gb-musgrave', 'Luke Musgrave', '2023–2025', 'The training room has seen a great deal more of him than the field has.', 76, 74, 90, 86, 80, 74, 88],
  ],
  hou: [
  ...
  ind: [
    ...
    ['now-ind-mallory', 'Will Mallory', '2023–2025', 'Runs a 4.6 and covers kicks, which is how a late pick stays employed.', 78, 80, 90, 76, 76, 80, 84],
    ['now-ind-mckeon', 'Sean McKeon', '2025–2025', 'Signed off the street to block, which is the whole of the job.', 72, 90, 74, 68, 64, 88, 86],
  ],
  jax: [
    ...
    ['now-jax-long', 'Hunter Long', '2025', 'One season in Jacksonville, almost all of it as an extra blocker.', 76, 90, 76, 74, 68, 86, 86],
  ],
  kc: [
    ...
    ['now-kc-tonyan', 'Robert Tonyan', '2024–2025', 'Caught eleven touchdowns in a season once and has been a spare part since.', 84, 78, 76, 80, 70, 80, 86],
  ],
  lv: [
    ...
    ['now-lv-okwuegbunam', 'Albert Okwuegbunam', '2024–2025', 'Ran a 4.49 at 258 pounds and has never learned to block.', 80, 62, 96, 74, 78, 70, 94],
  ...
  lac: [
    ...
    ['now-lac-dissly', 'Will Dissly', '2024–2025', 'Blocks better than anybody at the position and catches it in the flat.', 82, 94, 70, 76, 66, 92, 88],
  ...
  lar: [
    ...
    ['now-lar-kroft', 'Tyler Kroft', '2024–2025', 'Tenth season, and he has spent nine of them as somebody backup.', 76, 86, 74, 72, 66, 84, 86],
  ...
  mia: [
    ...
    ['now-mia-julianhill', 'Julian Hill', '2023–2025', 'Undrafted from Campbell and blocks on 90 percent of his snaps.', 68, 92, 76, 66, 62, 90, 88],
    ['now-mia-smith', 'Jonnu Smith', '2024–2025', 'Caught 88 passes in Miami at 29, which nobody had ever asked him to do.', 90, 78, 90, 84, 92, 88, 82],
  ],
  min: [
    ...
    ['now-min-grandy', 'Cam Grandy', '2026–', 'Illinois State tight end on his second practice squad inside a year.', 78, 78, 76, 74, 70, 80, 88],
    ...
    ['now-min-yurosek', 'Ben Yurosek', '2025–2025', 'Stanford tight end who went undrafted and made this roster in August.', 88, 66, 80, 76, 72, 80, 86],
  ],
  ne: [
    ...
    ['now-ne-arkin', 'Tanner Arkin', '2026–', 'Nobody drafted him and he has yet to dress for a game that counted.', 76, 84, 76, 70, 66, 84, 86],
    ['now-ne-latu', 'Cameron Latu', '2026–', 'Was a pass rusher at Alabama until they moved him and he got drafted.', 78, 82, 78, 74, 70, 82, 86],
    ['now-ne-bell', 'Jaheim Bell', '2024–2025', 'Carried the ball at South Carolina and weighs 240 pounds now.', 80, 74, 90, 74, 82, 80, 80],
    ['now-ne-dippre', 'CJ Dippre', '2025–2025', 'Alabama blocker taken in the seventh round to play on kicks.', 72, 90, 76, 68, 64, 88, 88],
  ],
  no: [
    ...
    ['now-no-fant', 'Noah Fant', '2026–', 'New Orleans signed him to run seams, which is all he has ever wanted.', 76, 62, 94, 82, 84, 72, 88],
    ...
    ['now-no-taysomhill', 'Taysom Hill', '2017–2025', 'Takes snaps under center and then hits somebody on the next play.', 84, 84, 88, 74, 88, 97, 88],
  ...
  nyg: [
    ...
    ['now-nyg-bellinger', 'Daniel Bellinger', '2022–2025', 'Moves people in the run game and quietly gets you 25 catches.', 78, 88, 78, 74, 70, 88, 88],
  ],
  nyj: [
    ...
    ['now-nyj-smartt', 'Stone Smartt', '2025', 'Spent a season with the Jets as the third tight end and the emergency arm.', 82, 62, 90, 78, 78, 80, 84],
  ],
  phi: [
  ...
  pit: [
    ...
    ['now-pit-parham', 'Donald Parham Jr.', '2025–2025', 'Six foot eight, and he has been carted off a field on live television.', 78, 78, 74, 72, 66, 84, 99],
  ...
  sf: [
    ...
    ['now-sf-juszczyk', 'Kyle Juszczyk', '2017–2025', 'A fullback who has made nine Pro Bowls, which should not be possible now.', 88, 94, 78, 78, 78, 94, 82],
  ...
  tb: [
    ...
    ['now-tb-dippre', 'CJ Dippre', '2026–', 'Tampa keeps him for the run game and all four special teams units.', 72, 90, 76, 68, 64, 88, 88],
    ['now-tb-culp', 'Devin Culp', '2024–2025', 'Ran a 4.47 at the combine and has hardly been active since.', 78, 76, 90, 72, 76, 78, 84],
  ],
  ten: [
    ...
    ['now-ten-whyle', 'Josh Whyle', '2023–2025', 'Three seasons in Tennessee blocking down and catching twenty a year.', 84, 90, 80, 70, 70, 88, 92],
  ],
  was: [
    ...
    ['now-was-jackson', 'Tyree Jackson', '2023–2025', 'Six foot seven, threw passes at Buffalo, and tore an Achilles catching one here.', 76, 80, 82, 70, 70, 80, 97],
