...
const POOLS: Record<string, Row[]> = {
  ari: [
    ...
    ['now-ari-dortch', 'Greg Dortch', '2022–2025', 'Five foot seven, returns punts, and turns up on third and six.', 92, 86, 84, 82, 70, 88, 54],
  ...
  atl: [
    ...
    ['now-atl-mooney', 'Darnell Mooney', '2024–2025', 'Runs past everybody and drops one a week that he should not.', 96, 76, 86, 88, 74, 84, 62],
  ...
  det: [
    ...
    ['now-det-patrick', 'Tim Patrick', '2024–2025', 'Missed two entire years to his knees and started again at 31.', 82, 88, 84, 74, 90, 68, 90],
  ...
  hou: [
    ...
    ['now-hou-metchie', 'John Metchie III', '2022–2025', 'Beat leukaemia between being drafted and playing his first professional game.', 90, 84, 86, 82, 76, 82, 76],
  ],
  ind: [
    ['now-ind-pittman', 'Michael Pittman Jr.', '2020–2025', 'Six foot four, and his job is making bad throws look like good ones.', 82, 92, 88, 80, 94, 76, 94],
  ...
  kc: [
    ...
    ['now-kc-moore', 'Skyy Moore', '2022–2025', 'Second round pick who muffed a punt in a Super Bowl and never recovered.', 90, 76, 80, 80, 70, 82, 66],
  ],
  lv: [
    ['now-lv-meyers', 'Jakobi Meyers', '2023–2025', 'Undrafted, and he has been the most reliable man on four bad offenses.', 84, 94, 92, 86, 84, 80, 82],
  ...
  no: [
    ...
    ['now-no-shaheed', 'Rashid Shaheed', '2022–2025', 'Undrafted, and he has taken a kick and a punt to the house in the same year.', 97, 84, 82, 86, 74, 94, 66],
  ...
  nyg: [
    ...
    ['now-nyg-robinson', 'Wan\'Dale Robinson', '2022–2025', 'Five foot eight, and he caught 93 passes without going more than ten yards.', 88, 92, 88, 84, 70, 84, 52],
  ...
  sf: [
    ...
    ['now-sf-jennings', 'Jauan Jennings', '2020–2025', 'Seventh round pick who caught three touchdowns in a game and blocks like a guard.', 82, 92, 88, 78, 94, 82, 88],
