...
const POOLS: Record<string, Row[]> = {
  ari: [
    ...
    ['now-ari-dortch', 'Greg Dortch', '2022–', 'Five foot seven, returns punts, and turns up on third and six.', 92, 86, 84, 82, 70, 88, 54],
    ['now-ari-jones', 'Zay Jones', '2025–', 'Caught 88 passes in a season once and has been a fourth option since.', 80, 88, 86, 76, 80, 72, 82],
    ['now-ari-fehoko', 'Simi Fehoko', '2024–', 'Six foot four, runs a 4.4, and has fifteen career catches.', 94, 72, 70, 74, 76, 76, 94],
    ['now-ari-weaver', 'Xavier Weaver', '2024–', 'Undrafted out of Colorado and has spent two years on the practice squad.', 92, 78, 76, 74, 70, 80, 68],
  ],
  atl: [
    ['now-atl-london', 'Drake London', '2022–', 'Six foot four, and he simply takes the ball off people in the air.', 84, 92, 90, 84, 97, 80, 97],
    ['now-atl-mooney', 'Darnell Mooney', '2024–', 'Runs past everybody and drops one a week that he should not.', 96, 76, 86, 88, 74, 84, 62],
    ['now-atl-mccloud', 'Ray-Ray McCloud', '2024–', 'On his fifth franchise and has returned kicks for all of them.', 92, 84, 82, 84, 66, 88, 58],
    ['now-atl-hodge', 'KhaDarel Hodge', '2023–', 'Special teams captain who caught 30 passes in a season by accident.', 88, 82, 76, 76, 78, 74, 84],
    ['now-atl-agnew', 'Jamal Agnew', '2024–', 'Has returned five kicks for touchdowns and lines up wide on Sundays.', 95, 78, 74, 82, 60, 92, 56],
    ['now-atl-sills', 'David Sills', '2024–', 'Was a quarterback recruit at 13 years old and is a receiver now.', 82, 84, 80, 72, 80, 68, 88],
  ],
  bal: [
    ...
    ['now-bal-hopkins', 'DeAndre Hopkins', '2025–', 'Made a one handed catch in a playoff game that people still talk about.', 78, 96, 94, 82, 96, 70, 90],
    ['now-bal-wallace', 'Tylan Wallace', '2021–', 'Won a game with a punt return in overtime and does nothing else.', 88, 78, 76, 74, 82, 82, 76],
    ...
    ['now-bal-agholor', 'Nelson Agholor', '2023–2024', 'Was a first round bust, then a Super Bowl starter, then a fourth receiver.', 88, 80, 84, 76, 78, 78, 76],
  ],
  buf: [
    ...
    ['now-buf-samuel', 'Curtis Samuel', '2024–', 'Was a running back at Ohio State and never picked a position after.', 92, 82, 80, 84, 68, 90, 66],
    ['now-buf-moore', 'Elijah Moore', '2025–', 'Second round talent who has been traded twice for very little.', 90, 84, 88, 86, 68, 88, 60],
    ['now-buf-shorter', 'Justin Shorter', '2023–', 'Six foot four fifth rounder who has never caught a pass that counted.', 86, 72, 72, 70, 78, 68, 92],
  ],
  car: [
    ...
    ['now-car-moore', 'David Moore', '2024–', 'Nine seasons and six franchises later he still gets open on the sideline.', 88, 80, 82, 78, 84, 74, 80],
    ['now-car-renfrow', 'Hunter Renfrow', '2025–', 'Was out of football for a year, and nobody has ever run a better option route.', 74, 92, 94, 88, 62, 76, 58],
  ],
  chi: [
    ['now-chi-moore', 'DJ Moore', '2023–', 'Has caught 80 passes a year for five quarterbacks who could not throw.', 90, 92, 92, 88, 88, 92, 84],
    ...
    ['now-chi-zaccheaus', 'Olamide Zaccheaus', '2025–', 'Seven seasons in the league for a man nobody wanted out of Virginia.', 90, 84, 84, 82, 74, 84, 58],
    ['now-chi-duvernay', 'Devin Duvernay', '2024–', 'Made two Pro Bowls as a returner and cannot get on the field otherwise.', 94, 78, 74, 78, 68, 88, 70],
    ['now-chi-scott', 'Tyler Scott', '2023–', 'Was a running back until his junior year of college and it shows.', 94, 74, 72, 76, 66, 84, 62],
  ],
  cin: [
    ...
    ['now-cin-jones', 'Charlie Jones', '2023–', 'Fourth round pick who returns punts and plays about ten snaps.', 90, 84, 84, 80, 64, 88, 62],
    ['now-cin-burton', 'Jermaine Burton', '2024–', 'Enormous talent, and every team that has had him has grown tired of him.', 92, 78, 82, 82, 84, 78, 78],
  ...
  cle: [
    ...
    ['now-cle-tillman', 'Cedric Tillman', '2023–', 'Six foot three, and he had one three week stretch where he was unstoppable.', 84, 84, 82, 76, 86, 76, 92],
    ['now-cle-bond', 'Isaiah Bond', '2025–', 'Ran a 4.39 and arrived with more off field noise than catches.', 96, 74, 78, 82, 70, 86, 62],
    ['now-cle-thrash', 'Jamari Thrash', '2024–', 'Two years of running scout team routes and waiting for somebody to pull a hamstring.', 90, 80, 80, 76, 70, 80, 64],
    ...
    ['now-cle-carter', 'DeAndre Carter', '2025–', 'Turned 32 on his eighth roster and is still back there fielding kicks.', 88, 82, 80, 78, 62, 84, 56],
  ],
  dal: [
    ...
    ['now-dal-tolbert', 'Jalen Tolbert', '2022–', 'Third round pick who took three seasons to catch 50 passes.', 88, 82, 84, 78, 82, 76, 82],
  ...
  den: [
    ...
    ['now-den-vele', 'Devaughn Vele', '2024–', 'Served a two year mission and turned up as a 27 year old rookie at six foot five.', 82, 88, 82, 72, 86, 70, 96],
  ...
  det: [
    ...
    ['now-det-raymond', 'Kalif Raymond', '2021–', 'Throws himself at linebackers twice his size on every running play.', 92, 84, 82, 80, 70, 88, 54],
    ['now-det-patrick', 'Tim Patrick', '2024–', 'Missed two entire years to his knees and started again at 31.', 82, 88, 84, 74, 90, 68, 90],
  ...
  gb: [
    ...
    ['now-gb-doubs', 'Romeo Doubs', '2022–', 'Fourth round pick who catches touchdowns and drops third downs.', 88, 80, 86, 80, 88, 76, 84],
    ['now-gb-wicks', 'Dontayvion Wicks', '2023–', 'Gets open more than anybody on the roster and cannot catch it.', 88, 66, 90, 86, 78, 82, 82],
    ...
    ['now-gb-heath', 'Malik Heath', '2023–', 'Makes this roster every August and nobody can quite explain how.', 82, 80, 78, 74, 88, 76, 84],
  ],
  hou: [
    ...
    ['now-hou-higgins', 'Jayden Higgins', '2025–', 'Second round pick from Iowa State who is six foot four and runs a 4.47.', 90, 88, 84, 78, 86, 76, 92],
    ...
    ['now-hou-dell', 'Tank Dell', '2023–', 'Was the most exciting man in Texas until his leg gave way in December.', 96, 86, 90, 90, 68, 92, 52],
    ['now-hou-hutchinson', 'Xavier Hutchinson', '2023–', 'Holds records at Iowa State and plays fifteen snaps a game here.', 84, 86, 82, 74, 86, 72, 88],
    ['now-hou-metchie', 'John Metchie III', '2022–2024', 'Beat leukaemia between being drafted and playing his first professional game.', 90, 84, 86, 82, 76, 82, 76],
  ],
  ind: [
    ['now-ind-pittman', 'Michael Pittman Jr.', '2020–', 'Six foot four, and his job is making bad throws look like good ones.', 82, 92, 88, 80, 94, 76, 94],
    ...
    ['now-ind-mitchell', 'AD Mitchell', '2024–', 'Second round pick with 4.34 speed and hands made of stone.', 96, 68, 80, 84, 74, 82, 84],
    ['now-ind-gould', 'Anthony Gould', '2024–', 'Weighs 175 pounds and is out there to make people miss in space.', 95, 78, 76, 78, 66, 88, 54],
    ['now-ind-campbell', 'Parris Campbell', '2019–2022', 'Second round pick who was hurt in all four of his seasons here.', 94, 80, 78, 80, 66, 88, 72],
  ],
  jax: [
    ...
    ['now-jax-jones', 'Tim Jones', '2022–', 'Undrafted from Southern Miss and has made a career on special teams.', 90, 80, 76, 74, 74, 80, 74],
  ...
  kc: [
    ...
    ['now-kc-brown', 'Hollywood Brown', '2024–', 'Went in the first round at five foot nine, and the deep shot is the whole card.', 96, 78, 84, 88, 68, 84, 54],
    ['now-kc-smithschuster', 'JuJu Smith-Schuster', '2022–', 'Was a 1,400 yard receiver at 22 and a fourth option by 26.', 80, 90, 84, 76, 84, 84, 84],
    ['now-kc-moore', 'Skyy Moore', '2022–', 'Second round pick who muffed a punt in a Super Bowl and never recovered.', 90, 76, 80, 80, 70, 82, 66],
    ['now-kc-hardman', 'Mecole Hardman', '2019–', 'Caught the touchdown that won a Super Bowl and forgot to run to the end zone once.', 96, 78, 76, 82, 62, 90, 58],
  ],
  lv: [
    ['now-lv-meyers', 'Jakobi Meyers', '2023–', 'Undrafted, and he has been the most reliable man on four bad offenses.', 84, 94, 92, 86, 84, 80, 82],
    ['now-lv-lockett', 'Tyler Lockett', '2025–', 'A decade of enormous catches in Seattle, and the burst has finally gone.', 86, 94, 94, 86, 76, 82, 62],
    ...
    ['now-lv-thornton', 'Dont\'e Thornton Jr.', '2025–', 'Six foot five and ran a 4.30, which is not a normal combination.', 97, 74, 74, 78, 80, 80, 96],
  ...
  mia: [
    ...
    ['now-mia-waddle', 'Jaylen Waddle', '2021–', 'Sixth overall pick who is somehow the second fastest man on his own team.', 97, 90, 90, 90, 76, 94, 58],
    ...
    ['now-mia-eskridge', 'Dee Eskridge', '2025–', 'Taken in the second round in 2021 and has barely been on a field since.', 94, 76, 76, 80, 62, 84, 60],
    ['now-mia-cracraft', 'River Cracraft', '2022–', 'Undrafted, and he has made a career out of blocking on running plays.', 80, 88, 80, 72, 74, 74, 72],
    ['now-mia-westbrookikhine', 'Nick Westbrook-Ikhine', '2025–', 'Caught nine touchdowns in a season and nobody outside the building noticed.', 88, 82, 82, 76, 88, 72, 90],
  ],
  min: [
    ...
    ['now-min-nailor', 'Jalen Nailor', '2022–', 'Turns up once a month with a 60 yard touchdown and then disappears.', 95, 80, 80, 82, 64, 86, 66],
    ['now-min-moore', 'Rondale Moore', '2025–', 'Squats 600 pounds at five foot seven and has never stayed healthy.', 94, 82, 78, 84, 74, 92, 54],
  ...
  ne: [
    ...
    ['now-ne-boutte', 'Kayshon Boutte', '2023–', 'Was a five star recruit and went in the sixth round for good reasons.', 88, 84, 82, 78, 84, 78, 80],
    ['now-ne-hollins', 'Mack Hollins', '2025–', 'Wears no socks in December and blocks like a tight end.', 86, 78, 76, 72, 82, 70, 92],
    ['now-ne-williams', 'Kyle Williams', '2025–', 'Third round rookie out of Washington State with a lot to prove.', 92, 84, 84, 82, 76, 86, 68],
    ['now-ne-bourne', 'Kendrick Bourne', '2021–', 'Catches everything in traffic and celebrates like nobody is watching.', 86, 90, 86, 78, 86, 84, 80],
  ],
  no: [
    ['now-no-olave', 'Chris Olave', '2022–', 'Runs a perfect route every time and has had four concussions doing it.', 92, 90, 96, 90, 82, 82, 74],
    ['now-no-shaheed', 'Rashid Shaheed', '2022–', 'Undrafted, and he has taken a kick and a punt to the house in the same year.', 97, 84, 82, 86, 74, 94, 66],
    ['now-no-cooks', 'Brandin Cooks', '2025–', 'Has 1,000 yard seasons for five different franchises, which is a record.', 92, 88, 90, 86, 74, 84, 62],
    ['now-no-wilson', 'Cedrick Wilson Jr.', '2023–', 'Signed a big contract elsewhere, was cut, and turned up here useful.', 82, 84, 88, 78, 80, 80, 78],
  ...
  nyg: [
    ...
    ['now-nyg-slayton', 'Darius Slayton', '2019–', 'Four times the leading receiver here, and nobody outside New Jersey knows him.', 94, 82, 84, 80, 84, 78, 80],
    ['now-nyg-robinson', 'Wan\'Dale Robinson', '2022–', 'Five foot eight, and he caught 93 passes without going more than ten yards.', 88, 92, 88, 84, 70, 84, 52],
    ['now-nyg-hyatt', 'Jalin Hyatt', '2023–', 'Won the Biletnikoff, ran a 4.4, and has 30 career catches.', 96, 76, 80, 82, 74, 82, 70],
    ['now-nyg-collins', 'Beaux Collins', '2025–', 'Walked on at Notre Dame, went unsigned, and started by September.', 88, 82, 78, 74, 84, 76, 84],
    ['now-nyg-shepard', 'Sterling Shepard', '2016–2023', 'Eight seasons here, and both Achilles tendons went in the end.', 88, 88, 88, 82, 68, 84, 58],
  ],
  nyj: [
    ...
    ['now-nyj-reynolds', 'Josh Reynolds', '2025–', 'Nine seasons in and nobody runs a prettier comeback route on third down.', 84, 84, 88, 78, 86, 72, 86],
    ['now-nyj-johnson', 'Tyler Johnson', '2024–', 'Fifth round pick who has hung around six seasons on route running alone.', 80, 86, 88, 78, 78, 76, 76],
    ['now-nyj-corley', 'Malachi Corley', '2024–', 'They called him the YAC king in college and he has not played much since.', 90, 80, 78, 80, 74, 92, 74],
    ['now-nyj-smith', 'Arian Smith', '2025–', 'Ran a 4.36 at Georgia and dropped a lot of what came his way.', 97, 68, 76, 82, 70, 84, 66],
    ['now-nyj-lazard', 'Allen Lazard', '2023–', 'Six foot five, and he followed his quarterback here for a lot of money.', 82, 80, 80, 74, 86, 70, 96],
  ],
  phi: [
    ['now-phi-brown', 'A.J. Brown', '2022–', 'Two hundred and twenty six pounds, and cornerbacks bounce off him.', 90, 92, 92, 88, 96, 94, 97],
    ...
    ['now-phi-dotson', 'Jahan Dotson', '2024–', 'First round pick who was traded for very little and plays 20 snaps.', 90, 82, 86, 82, 76, 80, 70],
    ['now-phi-wilson', 'Johnny Wilson', '2024–', 'Six foot six, and they use him as an extra blocker most weeks.', 82, 76, 74, 70, 86, 68, 99],
    ['now-phi-smith2', 'Ainias Smith', '2024–', 'Has dressed for about six games since Philadelphia spent a fifth on him.', 88, 82, 80, 78, 70, 82, 64],
    ['now-phi-covey', 'Britain Covey', '2022–2024', 'Five foot eight and 170 pounds, and he returned punts for a Super Bowl team.', 90, 84, 78, 78, 54, 86, 46],
  ],
  pit: [
    ...
    ['now-pit-austin', 'Calvin Austin III', '2022–', 'Ran a 4.32 and then spent two seasons hurt before anybody saw it.', 96, 82, 82, 84, 70, 88, 52],
    ['now-pit-wilson', 'Roman Wilson', '2024–', 'Third round pick who missed his entire rookie season with an ankle.', 94, 82, 84, 84, 70, 86, 66],
    ['now-pit-miller', 'Scotty Miller', '2024–', 'Runs a 4.38 and has been the fifth receiver for four franchises.', 95, 78, 78, 78, 60, 82, 56],
  ...
  sf: [
    ['now-sf-jennings', 'Jauan Jennings', '2020–', 'Seventh round pick who caught three touchdowns in a game and blocks like a guard.', 82, 92, 88, 78, 94, 82, 88],
    ['now-sf-pearsall', 'Ricky Pearsall', '2024–', 'Was shot in the chest in August and played that same season.', 92, 88, 90, 86, 82, 84, 76],
    ...
    ['now-sf-samuel', 'Deebo Samuel', '2019–2024', 'A receiver who ran for eight touchdowns in a season, which nobody does.', 90, 84, 82, 80, 88, 99, 92],
    ['now-sf-aiyuk', 'Brandon Aiyuk', '2020–', 'Averaged 17 yards a catch, got paid, and then lost a year to his knee.', 90, 88, 92, 88, 86, 90, 82],
  ],
  sea: [
    ...
    ['now-sea-valdesscantling', 'Marquez Valdes-Scantling', '2025–', 'Runs a 4.37, catches about half of them, and keeps getting signed.', 96, 68, 78, 80, 74, 78, 84],
    ['now-sea-bobo', 'Jake Bobo', '2023–', 'Nobody drafted him and he catches everything thrown at the back pylon.', 76, 90, 82, 70, 92, 66, 92],
  ...
  tb: [
    ['now-tb-evans', 'Mike Evans', '2014–', 'Has gone over a thousand yards every single year he has been in the league.', 84, 92, 92, 82, 97, 78, 97],
    ...
    ['now-tb-shepard', 'Sterling Shepard', '2024–', 'Ninth season, and he found a role here after New York gave up on him.', 86, 88, 86, 82, 66, 84, 58],
    ['now-tb-palmer', 'Trey Palmer', '2023–', 'Sixth round pick with 4.33 speed who has not held a job down yet.', 96, 76, 78, 82, 68, 84, 66],
  ],
  ten: [
    ...
    ['now-ten-jefferson', 'Van Jefferson', '2025–', 'His father coaches receivers, and he has been on five rosters in six years.', 90, 82, 84, 78, 82, 74, 80],
    ...
    ['now-ten-oliver', 'Bryce Oliver', '2025–', 'Youngstown State to an NFL roster, entirely on kick coverage.', 88, 78, 76, 74, 78, 76, 76],
  ...
  was: [
    ...
    ['now-was-samuel', 'Deebo Samuel', '2025–', 'Still runs it out of the backfield and still runs people over doing it.', 88, 84, 82, 80, 88, 96, 92],
    ['now-was-mccaffrey', 'Luke McCaffrey', '2024–', 'Was a quarterback at Nebraska, and his brother is the one everybody knows.', 88, 86, 84, 80, 74, 84, 72],
    ['now-was-brown', 'Noah Brown', '2024–', 'Ninth season, and he had one 200 yard game that nobody saw coming.', 84, 82, 82, 74, 88, 72, 88],
