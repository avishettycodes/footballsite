 ...
 * the other active players at that position. Every player tied for the highest raw source
 * value in a trait is 99, so a Current 99 uses the same scoring formula as an All-Time 99
 * instead of receiving an override or promoting a runner-up.
 *
